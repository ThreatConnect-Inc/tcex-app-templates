...
class AppInputModel(BaseSettings):
    ...
    # app inputs (from install.json)
    owners: str | None
    last_run: str | None
    indicator_types: list[str] | None
    tql: str | None
    tags: list[str] | None
    minimum_threatassess_socre: int | None
    minimum_threat_rating: int | None
    minimum_threat_confidence: int | None
    maximum_false_positives: int | None
